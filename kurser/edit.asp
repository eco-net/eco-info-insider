...
rsOrg.Source = "SELECT o.id,o.name, o.firstname,o.lastname  FROM eiorg_maindata o LEFT JOIN eicourse_r_org l ON o.id=l.orgid  WHERE l.courseid=" + Replace(rsOrg__cid, "'", "''") + ""
rsOrg.CursorType = 0
...
rsPageData.Source = "SELECT *  FROM eicourse_maindata  WHERE id=" + Replace(rsPageData__ColParam, "'", "''") + ""
...
rsCategories.Source = "SELECT c.id,c.name  FROM eicourse_cat_maindata c LEFT JOIN eicourse_r_cat o ON c.id=o.catid  WHERE o.courseid=" + Replace(rsCategories__ColParam, "'", "''") + ""
...
rsSubjects.Source = "SELECT s.id,s.name  FROM eicourse_r_sbj o LEFT JOIN eisbj_maindata s ON o.sbjid=s.id  WHERE o.courseid=" + Replace(rsSubjects__ColParam, "'", "''") + ""
...
Udfyldes kun, hvis kurset str&aelig;kker sig over flere dage.<br>
<br>
<span class="sidebarHeader">Arrang&oslash;rer</span> <br>
Der kan skrives flere arrang&oslash;rer.<br>
<br>
<span class="sidebarHeader">M&oslash;detid, Adresse</span> <span class="sidebarHeader">og 
Postnr</span><br>
Hvor kurset afholdes.<br>
<br>
<span class="sidebarHeader">Postnr </span><br>
Skriv kun postnr, ikke by.<br>
<br>
<span class="sidebarHeader">Beskrivelse:</span><br>
Beskrivelsen vises, n&aring;r nogen ser p&aring; dit kort i Kursus Kalenderen.<br>
...
<p><span class="sidebarHeader">Kort om uddannelsen:<br>
</span>Bruges til generel beskrivelse af uddannelsen.</p>
...
<tr> 
<td class="contentHeader1"> Rediger kursus 
...
<td width="50%"> 
<p><span class="formLabeltext">M&oslash;detid for kurset:</span><br>
<input type="text" name="meettime" size="32" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("starttime").Value)%>">
<span class="formLabeltext">Hjemrejsetidspunkt:</span><br>
<input type="text" name="hometime" size="32" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("hometime").Value)%>">
<br>
<span class="formLabeltext">Skolen (stedets navn):</span><br>
<input type="text" name="school" size="32" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("school").Value)%>">
<br>
<span class="formLabeltext"> Adresse:</span><br>
<input type="text" name="address" size="32" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("address").Value)%>">
<br>
...
<input type="text" name="emailaddress" value="<%=(rsPageData.Fields.Item("emailadress").Value)%>" size="32" class="formInputobjectLong">
<br>
...
<td><span class="formLabeltext">Kort resume af beskrivelse:</span><br>
...
<br>
<br>
Hvis kurset er en del af en uddannelse:<br>
<span class="listheader">Kort om uddannelsen:<br>
<textarea name="education" class="formTextobjectLow"><%=(rsPageData.Fields.Item("education").Value)%></textarea>
</span> 
<div align="center"> 
<input type="button" class="function" onClick="showeditor('education','');" value="Formater" name="button3">
</div>
</td>
</tr>
</table>
...
<td><b>Er emneordet B&aelig;redygtig Udvikling valgt vises kurset b&aring;de p&aring; 
&Oslash;ko-info og B&aelig;redygtigUdvikling.nu</b></td>
</tr>
</table>
<div align="center"> 
