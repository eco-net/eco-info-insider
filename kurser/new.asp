...
<tr> 
<td valign="top"> 
<p>Opret et nyt kursus ved at udfylde formularen. Brug de felter du finder n&oslash;dvendige, 
...
<tr> 
<td class="contentHeader1"> Nyt kursus</td>
</tr>
<tr> 
...
<textarea name="organizers" cols="32" class="formTextobjectLow">
<%=rsPagedata("name")%>
</textarea>
<br>
</td>
...
<input type="text" name="meettime" size="32" class="formInputobjectLong" value="">
<br>
<span class="formLabeltext">Hjemrejsetidspunkt:</span><br>
<input type="text" name="hometime" size="32" class="formInputobjectLong" value="">
<br>
<span class="formLabeltext">Skolen (stedets navn):</span><br>
<input type="text" name="school" size="32" class="formInputobjectLong" value="">
<br>
<span class="listheader">Adresse:</span><br>
...
<p>Hvis kurset er en del af en uddannelse:<br>
<span class="listheader">Kort om uddannelsen:<br>
<textarea name="education" class="formTextobjectLow"></textarea>
</span></p>
<div align="center"> 
