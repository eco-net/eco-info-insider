...
rsOrg.Source = "SELECT o.id  FROM eiorg_maindata o LEFT JOIN eicourse_r_org l ON o.id=l.orgid  WHERE l.courseid=" + Replace(rsOrg__ColParam, "'", "''") + ""
rsOrg.CursorType = 0
...
<%
DIM theText
theText="Du er ved at slette et kursus.<br><br>Er du sikker på at du vil fortsætte ? "
%>
...
<%END IF%>
<input type="button" value="Slet" class="formbutton" onClick="this.form.params.value=this.form.params.value.replace('listoffset','offset');this.form.action='act_delete.asp';this.form.submit();">
<input type="button" value="Fortryd" class="formbutton" onClick="history.go(-1)">
<br>
<br>
</td>
</tr>
