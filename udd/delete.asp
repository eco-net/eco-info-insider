...
rsOrg.Source = "SELECT o.id  FROM eiorg_maindata o LEFT JOIN eiudd_r_org l ON o.id=l.orgid  WHERE l.uddid=" + Replace(rsOrg__ColParam, "'", "''") + ""
rsOrg.CursorType = 0
...
<%
DIM theText
theText="Du er ved at slette en uddannelse.<br><br>Er du sikker på at du vil fortsætte ? "
%>
