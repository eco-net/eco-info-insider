...
rsPageData.Source = "SELECT m.id,m.title,m.shortdescription,m.status,m.modidate,m.createdate,m.maker,m.editor  FROM eiudd_maindata m  WHERE 0=0  ORDER BY m.title"
rsPageData.Source=replace(rsPageData.Source,"0=0",theWhere)
rsPageData.Source=replace(rsPageData.Source,"eiudd_maindata m",theFrom)
...
<td class="contentHeader1" colspan="2" width="98%">Fandt <%=rsPageData_total%> uddannelser<font color="#FF0000"><%=validtext%></font></td>
...
<td class="contentHeader1" height="22">Fandt ingen uddannelser</td>
<td width="8"><br>
</td>
</tr>
<tr> 
...
<br>
<br>
Der er ingen uddannelser, der matcher din søgning.<br>
