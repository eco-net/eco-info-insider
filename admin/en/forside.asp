...
theSQL="UPDATE en_mainpage SET title='" & request("title") &_
"',descr='" & request("descr") &_
"',img=" & request("img_id") &_
",link='" & request("link") &_
...
newsnumber=number
if request("changeNumber")>0 then

newsnumber=request("nr")

	l1=Chr(60) & Chr(37) & "Dim number" 
	l2="number=" & request("nr") & Chr(37) & Chr(62) 
	filename=server.MapPath("/log/econet/newsnr.inc")
	
	Set FSO = createobject("Scripting.FileSystemObject")
	
	Set Txtfile=FSO.CreateTextFile(filename,true)
	
	Txtfile.WriteLine(l1)
	Txtfile.WriteLine(l2)
	Txtfile.close
...
rsTema.Source = "SELECT *  FROM en_mainpage"
rsTema.CursorType = 0
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="5" >
              <tr>
                <td  colspan="2" bgcolor="#CCCCCC"><span class="contentHeader2">                </span></td>
              </tr>
            </table>
            <strong>Teaser p&aring; &Oslash;ko-net </strong><br>
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr bgcolor="#CCCC99">
                <td valign="top"  bgcolor="#CCCCCC">                  <p align="right"><br>
                </p></td>
                ...
                <textarea name="descr" class="formTextobjectLow"><%=(rsTema.Fields.Item("descr").Value)%></textarea>
                  ...
                  <p><span class="listheader">Link: </span>                      
                    <input name="link" type="text" class="formInputobject" id="link" value="<%=(rsTema.Fields.Item("link").Value)%>">
                      <br>
                      <span class="listheader"> Linktekst:</span>
                      <input value="<%=(rsTema.Fields.Item("linktext").Value)%>" type="text" name="linktext" class="formInputobject">
                  </p>
                  <p align="center">
              ...
              <tr bgcolor="#CCCC99">
                ...
                V&aelig;lg billede fra billeddatabasen:</p>
                  ...
                  <br>
                  <a href="/shared/graphics/layout/index.asp?sizes=5" target="_blank">Find Billede</a>
                  <p>Skriv Billednr:
...
Forside</span></span></td>
</tr>
<tr> 
<td class="formLabeltext" width="47%">Bestem her hvor mange nyheder der skal vises 
p&aring; forsiden&nbsp;&nbsp;</td>
<td align="right" width="53%"> 
<form name="form1" method="post" action="forside.asp">
<p align="center"> 
<input type="text" name="nr" size="4" value="<%=newsnumber%>">
<input type="hidden" name="changeNumber" value="1">
<br>
<input type="submit" name="Submit" value="Opdater" class="formSubmitbutton">
</p>
</form>
</td>
</tr>
