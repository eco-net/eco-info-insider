...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_editTable = "enblad_maindata"
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "nr|value"
  MM_columnsStr = "nr|none,none,NULL"
...
rsBlad.Source = "SELECT *  FROM enblad_maindata  ORDER BY nr desc"
rsBlad.CursorType = 0
...
rsChosen.Source = "SELECT nr  FROM enblad_maindata  WHERE chosen=1"
...
<tr> 
<td class="sidebarHeaderBox" colspan="2"><span><span class="sidebarHeader">&Oslash;ko-net 
Nyhedsblad </span></span></td>
</tr>
<tr> 
<td class="formLabeltext" width="47%"> &nbsp;&nbsp;Nyt &Oslash;ko-net Blad<br>
</td>
<td align="right" width="53%"> 
<form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
<span class="listheader">Nr.</span> 
...
<tr> 
<td class="formLabeltext" width="47%"> &nbsp;&nbsp;Rediger Blad</td>
<td align="right" width="53%"> 
<form name="form2" method="post" action="">
<select name="bladedit" class="formInputobject" onChange="window.location='blad/edit.asp?id=' + this.form.bladedit.options[this.form.bladedit.selectedIndex].value + '&name=' + this.form.bladedit.options[this.form.bladedit.selectedIndex].text;">
<option value="0" selected>V&aelig;lg </option>
<%
While (NOT rsBlad.EOF)
%>
<option value="<%=(rsBlad.Fields.Item("id").Value)%>" ><%=(rsBlad.Fields.Item("nr").Value)%></option>
<%
  rsBlad.MoveNext()
Wend
If (rsBlad.CursorType > 0) Then
  rsBlad.MoveFirst
Else
  rsBlad.Requery
End If
...
<tr> 
<td class="formLabeltext" width="47%"> V&aelig;lg Nyt Blad<br>
Aktuelt blad: 
<% If Not rsChosen.EOF Or Not rsChosen.BOF Then %>
<%=(rsChosen.Fields.Item("nr").Value)%> 
<% else response.write "ingen blad valgt" %>
...
<p class="listheader">Indf&oslash;ring i ops&aelig;tning af &Oslash;ko-net nyhedsbladet 
p&aring; nettet</p>
<p class="listheader"><br>
Bladet best&aring;r af:</p>
<ul>
<li>Teaser p&aring; forsiden af &Oslash;ko-net.</li>
<li>Indexside med nyeste blad og dets kapitler, og</li>
<li> oversigt over &aelig;ldre blade.<br>
Blade i oversigten fra 1 - 49 er gamle HTML dokumenter, </li>
<li>resten vises p&aring; index-siden. </li>
<li>Sider med de enkelte artikler.</li>
</ul>
</td>
<td align="right" width="53%"> 
<div align="left"> 
<p>Artikler til bladet p&aring; nettet skal v&aelig;re i Artikelbasen. Artikler 
kan evt. oprettes herfra. </p>
<p align="left"><b>Fremgangsm&aring;de for ops&aelig;tning af blad:</b></p>
</div>
<div align="left"> 
<ol>
<li> Opret nyt blad, med nr. </li>
<li>V&aelig;lg: Rediger blad</li>
<li>Opret forside p&aring; &Oslash;ko-net hjemmesiden</li>
<li>Opret Afsnit, som tekst.</li>
<li>Tildel Afsnittene linier, evt. som link til artikler fra artikelbasen</li>
<li>Upload pdf</li>
</ol>
<p>&nbsp;</p>
</div>
