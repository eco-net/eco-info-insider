...
pdf til blad nr: <%=request("name")%></span></span></td>
</tr>
<tr><td>
<form name="form1" method="post" action="uploadpdf.asp" enctype="multipart/form-data">
<div align="center"> 
<input type="hidden" name="id" value="<%=request("id")%>">
<input type="file" name="file" class="formInputobjectLong">
<input type="submit" name="Submit" value="Send" class="formSubmitbutton">
</div>
</form>
</td></tr>
</table>
