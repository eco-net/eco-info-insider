...
If (CStr(Request("MM_update")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "nr|value|aargang|value|dato|value|title|value|descr|value|img_id|value"
  MM_columnsStr = "nr|none,none,NULL|aargang|',none,''|dato|',none,''|title|',none,''|descr|',none,''|img_id|none,none,NULL"
...
Dim rsBlad__theID
rsBlad__theID = "0"
if (request("id")  <> "") then rsBlad__theID = request("id") 
%>
<%
Dim id, name
id=request("id")
...
rsBlad.Source = "SELECT *  FROM enblad_maindata  WHERE id=" + Replace(rsBlad__theID, "'", "''") + ""
rsBlad.CursorType = 0
...
<tr> 
<td  colspan="2" bgcolor="#CCCCCC"><span class="sidebarHeader">Rediger Blad</span><span class="contentHeader2"> 
<input value="<%=(rsBlad.Fields.Item("nr").Value)%>" type="text" name="nr" size="4">
</span></td>
</tr>
</table>
<span class="contentHeader2">Teaser p&aring; forsiden</span><br>
<table width="100%" border="0" cellspacing="0" cellpadding="5">
<tr bgcolor="#CCCC99"> 
...
<br>
&aring;rgang: 
<input value="<%=(rsBlad.Fields.Item("aargang").Value)%>" type="text" name="aargang" class="formInputobject">
<br>
dato: 
<input value="<%=(rsBlad.Fields.Item("dato").Value)%>" type="text" name="dato" class="formInputobject">
</p>
</td>
<td bgcolor="#CCCCCC" rowspan="2" valign="top"> 
<p><span class="formLabeltext"><br>
Overskrift:</span><br>
<input value="<%=(rsBlad.Fields.Item("title").Value)%>" type="text" name="title" class="formInputobjectLong">
<br>
<span class="formLabeltext">Tekst:</span><br>
<textarea name="descr" class="formTextobjectLow"><%=(rsBlad.Fields.Item("descr").Value)%></textarea>
</p>
<p>&nbsp;</p>
<p align="center"> 
...
<tr bgcolor="#CCCC99"> 
<td valign="top" bgcolor="#CCCCCC"> 
<p>Billede af bladet vises p&aring; forsiden, som nyeste og ved bladoversigt for 
det enkelte blad<span class="listheader"><br>
<a href="/shared/graphics/layout/index.asp?sizes=4" target="_blank"><span class="listheader">Find 
Billede</span></a> Skriv Billednr: 
<input value="<%=(rsBlad.Fields.Item("img_id").Value)%>" type="text" name="img_id" size="4">
</span></p>
</td>
</tr>
</table>
...
<input type="hidden" name="MM_recordId" value="<%= rsBlad.Fields.Item("id").Value %>">
</form>
<!-- #EndEditable --> </td>
</tr>
<tr> 
