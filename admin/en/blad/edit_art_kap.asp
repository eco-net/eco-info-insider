...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_editTable = "enblad_kap_r_art"
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "linktekst|value|art_id|value|orden|value|kap_id|value"
  MM_columnsStr = "linktekst|',none,''|art_id|none,none,NULL|orden|none,none,NULL|kap_id|none,none,NULL"
...
rsArt.ActiveConnection = MM_ecoinfo_STRING
rsArt.Source = "SELECT id, title  FROM eiart_maindata  ORDER BY title"
rsArt.CursorType = 0
...
rsKap.Source = "SELECT *  FROM enblad_kapitel  ORDER BY sort"
rsKap.CursorType = 0
...
Dim rsArtKap__kapID
rsArtKap__kapID = "0"
if (request("kapid") <> "") then rsArtKap__kapID = request("kapid")
%>
<%
set rsArtKap = Server.CreateObject("ADODB.Recordset")
rsArtKap.ActiveConnection = MM_ecoinfo_STRING
rsArtKap.Source = "SELECT *  FROM enblad_kap_r_art WHERE kap_id=" + Replace(rsArtKap__kapID, "'", "''") + ""
rsArtKap.CursorType = 0
rsArtKap.CursorLocation = 2
rsArtKap.LockType = 3
rsArtKap.Open()
rsArtKap_numRows = 0
%>
...
Dim Repeat1__index
Repeat1__index = 0
rsArtKap_numRows = rsArtKap_numRows + Repeat1__numRows
%>
...
<tr> 
<td> 
<p><span class="contentHeader2">Skriv linie i oversigten under Afsnittet:<br>
<%=request("kapname")%></span> </p>
<p>blad nr: <%=request("name")%></p>
<p>Hvis artikel id er st&oslash;rre end 0, bliver linktekst et aktivt link</p>
</td>
</tr>
</table>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr> 
<td class="listheader" colspan="4">Ny linie<br>
</td>
</tr>
<tr> 
<td class="listheader"> linktekst<br>
<input type="text" name="linktekst" class="formInputobjectLong">
</td>
<td class="listheader"> artikel id<br>
<input type="text" name="art_id" size="4" value="0">
</td>
<td class="listheader">orden<br>
<input type="text" name="orden" size="2" value="0">
</td>
<td class="listheader"> <br>
<input type="submit" name="Submit" value="Gem">
<input type="hidden" name="kap_id" value="<%=request("kapid")%>">
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr> 
<td class="listheader">Rediger linie</td>
</tr>
</table>
<% 
While ((Repeat1__numRows <> 0) AND (NOT rsArtKap.EOF)) 
%>
<form name="editform" method="POST" action="<%=MM_editAction%>">
<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr> 
<td class="listheader"> linktekst<br>
<input value="<%=(rsArtKap.Fields.Item("linktekst").Value)%>" type="text" name="linktekst" class="formInputobjectLong">
</td>
<td class="listheader"> artikel id<br>
<input type="text" name="art_id" size="4" value="<%=(rsArtKap.Fields.Item("art_id").Value)%>">
</td>
<td class="listheader">orden<br>
<input type="text" name="orden" size="2" value="<%=(rsArtKap.Fields.Item("orden").Value)%>">
</td>
<td class="listheader"> <br>
<input type="submit" name="Submit2" value="Gem">
<input type="hidden" name="kap_id" value="<%=(rsArtKap.Fields.Item("kap_id").Value)%>">
</td>
</tr>
</table>
<input type="hidden" name="MM_update" value="true">
<input type="hidden" name="MM_recordId" value="<%= rsArtKap.Fields.Item("id").Value %>">
</form>
<% 
