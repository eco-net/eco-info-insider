...
<span class="contentHeader1">Adminstration af Eco-info</span>
<br>
<br>
<br>
<span class="contentHeader2">Sm&aring; Forside-historier</span>
...
<tr>
<td class="formLabeltext"> &nbsp;&nbsp;Ny historie</td>
<td align="right">
<input type="button" value="Opret ..." onClick="window.location='/admin/cron.asp';" class="formbutton">
</td>
</tr>
<tr>
<td class="formLabeltext"> &nbsp;&nbsp;Rediger historie</td>
<td align="right">
<select name="menu1" onChange="MM_jumpMenu('parent',this,0)" class="formInputobject">
<option selected>Vælg</option>
<option value="sections/dgbcoll.asp">Aktuelle publikationer</option>
<option value="sections/dgscoll.asp">Aktuelle organisationer</option>
</select>
<input type="button" value="Rediger ..." onClick="window.location='/admin/cron.asp';" class="formbutton">
</td>
</tr>
<tr>
<td class="formLabeltext"> &nbsp;&nbsp;Slet historie</td>
<td align="right">
<select name="menu1" onChange="MM_jumpMenu('parent',this,0)" class="formInputobject">
<option selected>Vælg</option>
<option value="sections/dgbcoll.asp">Aktuelle publikationer</option>
...
<input type="button" value="Slet ..." onClick="window.location='/admin/cron.asp';" class="formbutton">
</td>
</tr>
<tr>
<td class="formLabeltext" colspan="2" height="1" align="center"><img src="/shared/graphics/layout/dots_vert.gif" width="100%" height="1"></td>
</tr>
<tr>
<td class="formLabeltext"> &nbsp;&nbsp;V&aelig;lg historier til Forside</td>
<td align="right">
<input type="button" value="Vælg ..." onClick="window.location='/admin/cron.asp';" class="formbutton">
</td>
</tr>
</table>
</td>
...
<br>
<span class="contentHeader2">
Store Forside-historier</span>
<table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#666666">
<tr>
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FAFAF4">
...
<tr>
<td class="formLabeltext"> &nbsp;&nbsp;V&aelig;lg historie til Forside</td>
<td align="right">
<input type="button" value="Vælg ..." onClick="window.location='/admin/cron.asp';" class="formbutton">
</td>
</tr>
