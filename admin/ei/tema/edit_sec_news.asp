...
If (CStr(Request("MM_update")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "tema_mrk|value|nyt_mrk|value|link|value|linkdescr|value|linie|value|show|value|sponsor|value"
  MM_columnsStr = "tema_mrk|none,1,0|nyt_mrk|none,1,0|linktekst|',none,''|tekst|',none,''|linie|none,none,NULL|show|none,1,0|sponsor|',none,''"
...
%>
<%
if Len(request("MM_insert"))>0 or Len(request("MM_update"))>0 then
writeSections(0)
end if
%>
...
rssek.Source = "SELECT *  FROM eitema_sektion  WHERE tema_id=" + Replace(rssek__temaid, "'", "''") + " AND sek='news'  ORDER BY linie"
rssek.CursorType = 0
...
<tr height="20"> 
<td> 
<div align="center"><img src="/shared/graphics/layout/tema.gif"> 
<input type="checkbox" name="tema_mrk" value="checkbox" <%If rssek.Fields.Item("tema_mrk").Value = 1 Then Response.Write("CHECKED") : Response.Write("")%> >
<br>
<img src="/shared/graphics/layout/nyt.gif" width="40" height="12"> 
<input type="checkbox" name="nyt_mrk" value="checkbox" <%If rssek.Fields.Item("nyt_mrk").Value = 1 Then Response.Write("CHECKED") : Response.Write("")%> >
</div>
</td>
<td> 
...
<input value="<%=(rssek.Fields.Item("sponsor").Value)%>" type="text" name="sponsor" size="20" class="formInputobject">
</div>
</td>
<td> 
<div align="right"><br>
