...
rsTema.Source = "SELECT *  FROM eitema_maindata  WHERE id=" + Replace(rsTema__theID, "'", "''") + ""
rsTema.CursorType = 0
...
<tr> 
<td  colspan="2" bgcolor="#CCCCCC"><span class="sidebarHeader">Rediger Tema </span><span class="contentHeader2"> 
...
<p><span class="listheader">Link til temaside:</span> 
...
Billede skal v&aelig;re Branding <br>
<br>
<a href="/admin/ei/billedbasen/index.asp?sizes=1" target="_blank">Find Billede</a> 
<p>Skriv Billednr: 
