...
rssekdgs.Source = "SELECT *  FROM eitema_sektion  WHERE tema_id=" + Replace(rssekdgs__temaid, "'", "''") + " AND sek='dgs'  ORDER BY linie"
...
<input type="checkbox" name="tema_mrk" value="checkbox" <%If rssekdgs.Fields.Item("tema_mrk").Value = 1 Then Response.Write("CHECKED") : Response.Write("")%> >
<br>
<img src="/shared/graphics/layout/nyt.gif" width="40" height="12"> 
<input type="checkbox" name="nyt_mrk" value="checkbox" <%If rssekdgs.Fields.Item("nyt_mrk").Value = 1 Then Response.Write("CHECKED") : Response.Write("")%> >
</div>
</td>
<td> 
...
<input value="<%=(rssekdgs.Fields.Item("sponsor").Value)%>" type="text" name="sponsor" size="20" class="formInputobject">
</div>
</td>
<td> 
<div align="right"><br>
