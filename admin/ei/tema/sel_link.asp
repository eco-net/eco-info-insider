...
function setLink(theform) {
	if(theform.linktype.value==1){theform.linktext.value='/dgs/detail.asp?id=' + theform.theid.options[theform.theid.selectedIndex].value;theform.linkdescr.value='Organisatonen ' + theform.theid.options[theform.theid.selectedIndex].text + '.'}
	...
	else if(theform.linktype.value==6){theform.linktext.value='/dgs/list.asp?dgscat=' + theform.theid.options[theform.theid.selectedIndex].value;theform.linkdescr.value='Kategorien ' + theform.theid.options[theform.theid.selectedIndex].text + ' i De Grønne Sider.'}
...
<br>
<br>
<select name="select" class="formInputobjectLong" onChange="setLink(this.form)">
<%=theOptions%> 
</select>
<br>
<input type="hidden" name="linktext">
<input type="hidden" name="linkdescr">
<input type="hidden" name="formname" value="<%=request("f")%>">
<br>
<input type="button" name="Button" value="&lt;&lt;Tilbage" onClick="this.form.step.value='1';this.form.submit();" class="formbutton">
<input type="button" name="Button" value="OK" class="formSubmitbutton" onClick="alert(this.form.linkdescr.value);opener.document.forms[this.form.formname.value].link.value=this.form.linktext.value;opener.document.forms[this.form.formname.value].linkdescr.value=this.form.linkdescr.value;window.close();">
