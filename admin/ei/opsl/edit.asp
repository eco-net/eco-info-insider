...
theSQL="UPDATE eiopsl_maindata SET title='" & request("title") & "',cat_id=" & request("cat_id") & ",kort_beskrivelse='" & Trim(request("kort_beskrivelse")) & "',lang_beskrivelse='" & Trim(request("lang_beskrivelse")) & "',indsender='" & request("indsender") & "',email='" & request("email") & "',postnr=" & request("postnr") & ",telefon='" & request("telefon") &  "',billede_filnavn='" & request("billede_filnavn") & "' WHERE id=" & id
...
rsPageData.Source = "SELECT * FROM eiopsl_maindata WHERE id=" & id
...
<p>&nbsp;</p>
<p align="center" class="homeHeader"><a href="new.asp">Nyt Opslag</a> </p>
<!-- #EndEditable --></td>
...
<td valign="top"> <!-- #BeginEditable "maincontent" -->
  <form name="form1" method="post" action="edit.asp">
    <table width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
      <tr>
        <td class="contentHeader1"><p>Ret et Opslag </p>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top">
                <td><span class="formLabeltext">*Titel:</span><br>
                    <input name="title" type="text" class="formInputobject" id="title" value="<%=rsPageData("title")%>">
                    <br>
				  ...
				  while not rsCat.EOF%>
                      <option value="<%=rsCat("id")%>" <%if rsCat("id")=rsPageData("cat_id") then response.write "SELECTED"%>><%=rsCat("name")%></option>
                      <%
				  rsCat.MoveNext
				  wend
				  end if
                  ...
                  &nbsp;&nbsp;(max 100 tegn)<br>
                  <textarea name="kort_beskrivelse" class="formTextobject" cols="25" rows="5" wrap="VIRTUAL"><%=rsPageData("kort_beskrivelse")%></textarea>
                  <br>
                  <span class="formLabeltext">Uddybende beskrivelse:</span><br>
                  &nbsp;&nbsp;(max 8000 tegn)<br>
                  <textarea name="lang_beskrivelse" class="formTextobject" cols="25" rows="5"><%=rsPageData("lang_beskrivelse")%></textarea>
                ...
                <td><p><span class="formLabeltext">*Navn:</span><br>
                        <input type="text" name="indsender" class="formInputobject" value="<%=rsPageData("indsender")%>">
                        <br>
                        <span class="formLabeltext">*E-mail adresse:</span><br>
                        <input type="text" name="email" class="formInputobject" value="<%=rsPageData("email")%>">
                        <br>
                        <span class="formLabeltext">Postnr:</span><br>
                        <input type="text" name="postnr" class="formInputobject" value="<%=rsPageData("postnr")%>">
                        <br>
                        <span class="formLabeltext">Telefon:</span><br>
                        <input type="text" name="telefon" class="formInputobject" value="<%=rsPageData("telefon")%>">
                        <br>
                  </p>
                    <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  ...
                  <p>Billedsti:<br>
                    ...
                    <input name="billede_filnavn" type="text" id="billede_filnavn" value="<%=rsPageData("billede_filnavn")%>">
                  </p>
                  <p>
                    <input type="reset" name="reset2" value="Ryd" class="formbutton">
                  </p>
                  <p>
                      <input name="submit" type="submit" class="formSubmitbutton" id="submit" onClick="MM_validateForm('titel','','R','indsender','','R','email','','RisEmail','kort_beskrivelse','','R');return document.MM_returnValue" value="Ret">
