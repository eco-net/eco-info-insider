...
rsPageData.Source = "SELECT *  FROM eiopsl_maindata ORDER BY createdate desc"
...
location.href="delopsl.asp?id=" + id;
}
}
</script>
<!-- #EndEditable --> 
...
<p>&nbsp;</p>
<p align="center"><a href="new.asp" class="homeHeader">Nyt Opslag</a></p>
<!-- #EndEditable --></td>
...
<td valign="top"> <!-- #BeginEditable "maincontent" -->
  ...
  <p class="contentHeader1">Opslagstavlen</p>
  <table width="100%" border="1" align="center" cellpadding="1" cellspacing="0"> 
  <tr><td>slet</td>
      <td width="75" nowrap><span class="style3">&nbsp;</span></td>
      <td><span class="style3"><strong>Rediger&nbsp;</strong></span></td>
      <td><span class="style3"><em>&nbsp;</em></span></td>
      <td>&nbsp;</td>
    </tr>
  <% if not rsPageData.EOF then 
  while not rsPageData.EOF %>
  <tr><td><a href="javascript:del('<%=rsPageData("id")%>')">slet</a></td>
      <td width="75" nowrap><span class="style3"><%=FormatDate(rsPageData("createdate"))%>&nbsp;</span></td>
      <td><span class="style3"><strong><a href="edit.asp?id=<%=rsPageData("id")%>"><%=rsPageData("title")%></a>&nbsp;</strong></span></td>
      <td><span class="style3"><em><%=rsPageData("indsender")%>&nbsp;</em></span></td>
      <td><a href="mailto:<%=rsPageData("email")%>" class="style1 style2"><%=rsPageData("email")%>&nbsp;</a></td>
    </tr>
  <% 
  rsPageData.MoveNext
  wend
