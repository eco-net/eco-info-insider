...
<form name="form1" method="post" action="act_sendmail.asp" onSubmit="if(this.headline.value.length==0 || this.body.value.length==0){alert('Begge felter skal udfyldes');return false};else return true;">
...
<textarea name="body" class="formTextobjectBigger"></textarea>
<br>
<%IF request("mail")=2 THEN 
...
<input type="button" name="Submit" value="Send" class="formSubmitbutton" onClick="MM_test(0,this.form);">
<input type="hidden" name="mail" value="<%=request("mail")%>">
<input type="hidden" name="test">
<input type="button" name="Submit4" value="Test" class="formSubmitbutton" onClick="MM_test(1,this.form);">
</form>
</td>
</tr>
</table>
