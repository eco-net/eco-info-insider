...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_editTable = "bestyrelse_maindata"
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "navn|value|stilling|value|email|value|telefon|value"
  MM_columnsStr = "navn|',none,''|stilling|',none,''|email|',none,''|telefon|',none,''"
...
%>
<%
IF request("doUpdate")=1 THEN
	DIM theSQL,i
	theSQL=""
	i=1
	FOR each item in request("id")
		theSQL=theSQL & "UPDATE bestyrelse_maindata SET navn='" & request("navn")(i) & "',stilling='" & request("stilling")(i)  & "',email='" & request("email")(i) & "',orden=" & CInt(request("orden")(i)) & ",telefon='" & request("telefon")(i) & "' WHERE id=" & item & ";" & chr(13)
		i=i+1
	NEXT
	DIM theComm
    ...
    theComm.ActiveConnection = MM_ecoinfo_STRING
 	IF LEN(request("delete"))>0 THEN
		theComm.CommandText="Delete FROM bestyrelse_maindata WHERE id IN (" & request("delete") & ")"
		theComm.Execute
	END IF
...
<p>&nbsp;</p>
<p><span class="contentHeader1">Bestyrelse</span><br>
</p>
<form name="form1" action="index.asp">
<table width="" border="0" cellspacing="0" cellpadding="0">
<tr> 
<td class="listheader">Navn</td>
<td class="listheader">Stilling</td>
<td class="listheader">Email</td>
<td class="listheader">Telefon</td>
<td class="listheader">Orden</td>
<td class="listheader">Slet</td>
</tr>
<% 
...
<tr> 
<td> 
<input value="<%=(rsPageData.Fields.Item("navn").Value)%>" type="text" name="navn" class="formInputobject">
</td>
<td> 
<input value="<%=(rsPageData.Fields.Item("stilling").Value)%>" type="text" name="stilling" class="formInputobject">
</td>
<td> 
<input value="<%=(rsPageData.Fields.Item("email").Value)%>" type="text" name="email" class="formInputobject">
</td>
<td><input name="telefon" type="text" class="formInputobject" id="telefon" value="<%=(rsPageData.Fields.Item("telefon").Value)%>"> 
</td>
<td><div align="center">
  <input value="<%=(rsPageData.Fields.Item("orden").Value)%>" type="text" name="orden" size="2"> 
</div></td>
<td><input type="hidden" name="id" value="<%=(rsPageData.Fields.Item("ID").Value)%>">
  <input type="checkbox" name="delete" value="<%=(rsPageData.Fields.Item("id").Value)%>"></td>
</tr>
<% 
...
<tr> 
<td> 
<input type="text" name="navn" class="formInputobject">
</td>
<td> 
<input type="text" name="stilling" class="formInputobject">
</td>
<td> 
<input type="text" name="email" class="formInputobject">
</td>
<td><input name="telefon" type="text" class="formInputobject" id="telefon"> 
  </td>
</tr>
</table>
<div align="center"><br>
  <input type="hidden" name="MM_insert" value="true">
  <input type="submit" name="Submit2" value="Inds&aelig;t" class="formbutton">
</div>
</form>
<!-- #EndEditable --> </td>
</tr>
