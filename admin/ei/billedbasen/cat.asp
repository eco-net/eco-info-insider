...
If (CStr(Request("MM_insert")) <> "") Then
  ...
  MM_editTable = "image_cat_maindata"
  MM_editRedirectUrl = ""
...
<tr> 
<td class="sidebarHeaderBox" colspan="2"><span><span class="sidebarHeader">Rediger 
Kategorier </span></span></td>
</tr>
<tr> 
<td> 
...
<div align="left"> 
<input type="hidden" name="MM_recordId" value="<%= rsCat.Fields.Item("id").Value %>">
id:&nbsp; <%=(rsCat.Fields.Item("id").Value)%> &nbsp; 
<input value="<%=(rsCat.Fields.Item("name").Value)%>" type="text" name="name">
...
<input type="hidden" name="hiddenField" value="<%=(rsCat.Fields.Item("id").Value)%> ">
...
<table width="90%" border="0" cellspacing="0" cellpadding="1"  bgcolor="#666666" align="center">
<tr> 
<td class="sidebarHeaderBox"><span class="sidebarHeader">Ny Kategori </span> 
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FAFAF4">
<tr> 
<td> 
<div align="center"> 
<input type="text" name="name">
<input type="submit" name="Submit2" value="Inds&aelig;t" class="formSubmitbutton">
</div>
</td>
</tr>
</table>
