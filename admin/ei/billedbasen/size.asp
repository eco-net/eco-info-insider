...
If (CStr(Request("MM_update")) <> "" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "image_size"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "name|value|sizeinfo|value"
  MM_columnsStr = "name|',none,''|sizeinfo|',none,''"
...
%>
<%
set rs_Size = Server.CreateObject("ADODB.Recordset")
rs_Size.ActiveConnection = MM_ecoinfo_STRING
rs_Size.Source = "SELECT *  FROM image_size"
rs_Size.CursorType = 0
rs_Size.CursorLocation = 2
rs_Size.LockType = 3
rs_Size.Open()
rs_Size_numRows = 0
%>
...
<tr> 
<td class="sidebarHeaderBox" colspan="3"><span><span class="sidebarHeader">Rediger 
St&oslash;rrelser </span></span></td>
</tr>
<tr> 
<td colspan="3"> 
...
<input value="<%=(rs_Size.Fields.Item("name").Value)%>" type="text" name="name" class="formInputobject">
<input value="<%=(rs_Size.Fields.Item("sizeinfo").Value)%>" type="text" name="sizeinfo" class="formInputobject">
<input type="submit" name="Submit" value="Gem" class="formSubmitbutton">
<input type="hidden" name="MM_update" value="true">
<input type="hidden" name="MM_recordId" value="<%= rs_Size.Fields.Item("id").Value %>">
</form>
</td>
</tr>
</table>
...
<input type="submit" name="Submit2" value="Slet" class="formSubmitbutton">
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#FAFAF4">
<tr> 
<td class="sidebarHeaderBox" colspan="3"><span><span class="sidebarHeader">Ny 
St&oslash;rrelse</span></span></td>
</tr>
<tr> 
<td colspan="3"> 
<table width="100%" border="0" cellspacing="0" cellpadding="5">
...
<div align="center">navn: 
<input type="text" name="name" class="formInputobject">
str: 
<input type="text" name="sizeinfo" class="formInputobject">
<input type="submit" name="Submit3" value="Opret" class="formSubmitbutton">
...
St&oslash;rrelsen bestemmer hvor billedet kan bruges p&aring; &Oslash;ko-nets 
sites.<br>
Giv et entydigt navn, og skriv den anbefalede str, som tekst.</td>
</tr>
</table>
</td>
</tr>
