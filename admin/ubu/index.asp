...
theSQL="INSERT INTO ubu_news_maindata (title,createdate,shortdescription,description,right_col) VALUES ('" & request("title") & "','" & Date() & "','" & request("shortdescription") & "','" & request("description") & "','" & request("right_col") & "')"
...
rsPageData.Source = "SELECT *  FROM ubu_news_maindata ORDER BY createdate desc"
...
%>
  <tr>
    <td><%=FormatDate(rsPageData("createdate"))%></br><a href="edit.asp?id=<%=rsPageData("id")%>"><%=rsPageData("title")%></a><br></td>
  </tr>
  <%rsPageData.MoveNext
wend
end if
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td width="60%"><p><strong>Overskrift:</strong><br>
          <input name="title" type="text" id="title" style="width: 100%" size="30">
      </p>
        <p><strong>Teaser til forsiden af UBU10: </strong><br>
          <textarea id="shortdescription" name="shortdescription" rows="10" cols="30" style="width: 100%"><%=tekst%></textarea>
        </p>
        <p><strong>Uddybende tekst til nyhedssiden:</strong><br>
          <textarea id="description" name="description" rows="30" cols="30" style="width: 100%"><%=tekst2%></textarea>
</p>
        <p>
          <label> </label>
          <strong>H&oslash;jre spalte p&aring; nyhedssiden: </strong><br>
          <textarea id="right_col" name="right_col" rows="10" cols="10" style="width: 100%"><%=tekst3%></textarea>
</p></td>
      <td width="40%" valign="top"><div align="center">
        ...
        <p align="left">Billeder uploades med FTP til mappen: www.ubu10/media </p>
        <p align="left">Billedbredder:</p>
        <p align="left">P&aring; forside og i uddybende tekst kan billeder h&oslash;jst v&aelig;re 320 pixel brede.</p>
        <p align="left">I h&oslash;jre spalte kan billeder h&oslash;jst v&aelig;re 150 pixel brede.  </p>
      </div></td>
    </tr>
  </table>
  <p>
