...
theSQL="UPDATE ubu_news_maindata SET title='" & request("title") & "',shortdescription='" & request("shortdescription") & "',description='" & request("description") & "',right_col='" & request("right_col") & "' WHERE id=" & id
...
location.href="delnews.asp?id=" + id;
}
}
</script>
<!-- #EndEditable --> 
...
<table width="90%" border="0" align="center" cellpadding="5" cellspacing="0">
  <tr>
    <td><span class="contentHeader1"><br>
UBU10 NYHEDER</span> </td>
  </tr>
...
<td valign="top"> <!-- #BeginEditable "maincontent" -->
  ...
  <script type="text/javascript" src="/tiny/tinymce/jscripts/tiny_mce/tiny_mce.js"></script>
  <script language="javascript">
...
<p>&nbsp;</p>
<p><span class="homeHeader">&nbsp;Ret nyhed</span>
</p>
<form action="edit.asp" method="post" name="form1" id="form1">
  <p>&nbsp;<%=FormatDate(rsPageData("createdate"))%></p>
  <table width="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td width="60%"><p><strong>Overskrift:</strong><br>
          <input name="title" type="text" id="title" style="width: 100%" value="<%=rsPageData("title")%>" size="30">
      </p>
        <p><strong>Teaser til forsiden af UBU10: </strong><br>
          <textarea id="shortdescription" name="shortdescription" rows="10" cols="30" style="width: 100%"><%=rsPageData("shortdescription")%></textarea>
        </p>
        <p><strong>Uddybende tekst til nyhedssiden:</strong><br>
          <textarea id="description" name="description" rows="30" cols="30" style="width: 100%"><%=rsPageData("description")%></textarea>
</p>
        <p>
          <label> </label>
          <strong>H&oslash;jre spalte p&aring; nyhedssiden: </strong><br>
          <textarea id="right_col" name="right_col" rows="10" cols="10" style="width: 100%"><%=rsPageData("right_col")%></textarea>
</p></td>
      <td width="40%" valign="top"><div align="center"><br>
            ...
            <input type="button" name="Submit2" value="Slet" onClick="javascript:del('<%=rsPageData("id")%>')">
      </div></td>
    </tr>
  </table>
  <p>
