...
if (Request.QueryString("id") <> "") then rsPageData__MMColParam = Request.QueryString("id")
%>
<%
set rsPageData = Server.CreateObject("ADODB.Recordset")
rsPageData.ActiveConnection = MM_ecoinfo_STRING
rsPageData.Source = "SELECT * FROM eiba_maindata WHERE id = " + Replace(rsPageData__MMColParam, "'", "''") + ""
...
<tr> 
<td valign="top"> <span class="contentHeader1"><br>
Rediger Branding Area</span> 
<form name="form1" method="post" action="act_edit.asp" enctype="multipart/form-data" onSubmit="doedit(document.forms[0]);return document.validation;">
<span class="formLabeltext">Overskrift:</span><br>
<input type="text" name="headline" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("headline").Value)%>">
<br>
<span class="formLabeltext">Tekst:</span><br>
<textarea name="body" class="formTextobjectLow"><%=(rsPageData.Fields.Item("body").Value)%></textarea>
<br>
<span class="formLabeltext">Billede:</span><br>
<img src="<%=(rsPageData.Fields.Item("imagepath").Value)%>" width="64" height="45"><br>
<input type="file" name="file" class="formInputobjectLong">
(258 bredt, 200 h&oslash;jt)<br>
<!--
<span class="formLabeltext">Link:</span><br>
<input type="text" name="link" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("link").Value)%>">
<input type="hidden" name="linkdescr" value="<%=(rsPageData.Fields.Item("linkdescr").Value)%>">
<input type="button" name="Submit2" value="V&aelig;lg ..." onClick="window.open('/shared/sel_link.asp','thewin','width=300,height=300,top=200,left=300')" class="formbutton">
<br>
Aktuel link: <%=(rsPageData.Fields.Item("linkdescr").Value)%> <br>
<br>
<span class="formLabeltext">Linkaction:</span><br>
<input type="text" name="linkaction" class="formInputobjectLong" value="<%=(rsPageData.Fields.Item("linkaction").Value)%>">
(onClick=&quot;...&quot;)<br>
-->
<br>
<input type="reset" name="Reset" value="Fortryd" class="formbutton" onClick="window.location='/admin/bu/homepage/functions.asp'">
