...
IF CInt(request("done"))=1 THEN
	theText="Branding Area'en er oprettet."
ELSEIF CInt(request("done"))=2 THEN
	theText="Branding Area'en er opdateret."
ELSEIF CInt(request("done"))<5 THEN
	theText="Branding Area'en er slettet."
ELSE
	theText="Branding Area'en på forsiden er opdateret."
END IF
%>
...
<!--#include file="/admin/bu/inc_leftbar.asp"-->
<!-- #EndEditable --></td>
...
<form name="form1" method="post" action="/admin/bu/homepage/functions.asp">
