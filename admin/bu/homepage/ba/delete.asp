...
IF LEN(request("del"))=0 THEN
	...
	if (Request("id") <> "") then rsPagedata__MMColParam = Request("id")
	%>
	<%
	set rsPagedata = Server.CreateObject("ADODB.Recordset")
	rsPagedata.ActiveConnection = MM_ecoinfo_STRING
	rsPagedata.Source = "SELECT headline FROM eiba_maindata  WHERE id = " + Replace(rsPagedata__MMColParam, "'", "''") + ""
...
<!--#include virtual="/admin/bu/inc_leftbar.asp" -->
<!-- #EndEditable --></td>
...
<div align="center"><span class="contentHeader1">Advarsel</span> <span></span></div>
</td>
</tr>
<tr> 
<td class="formLabeltext" align="center"><span class="formLabeltext"><br>
<br>
Er du sikker p&aring;, at du vil slette Branding Area'en<br>
<br><%=(rsPagedata.Fields.Item("headline").Value)%>
</span></td>
</tr>
<tr> 
<td class="formLabeltext" align="center"> <br>
<br>
<input type="hidden" name="id" value="<%=request("id")%>">
<input type="hidden" name="state" value="<%=state%>">
<input type="hidden" name="name" value="<%=(rsPagedata.Fields.Item("headline").Value)%>">
<input type="submit" name="Submit2" value="Fortryd" class="formbutton" onClick="this.form.action='/admin/bu/homepage/functions.asp';this.form.submit();">
<input type="submit" name="Submit" value="OK" class="formbutton">
<br>
<br>
</td>
</tr>
...
<td class="formLabeltext" align="center"><span class="formLabeltext"><br>
<br>
Den Branding Area du er ved at slette, bruges p&aring; Forsiden. V&aelig;lg en 
anden der skal bruges i stedet.<br>
<br>
<br>
</span> 
<input type="hidden" name="id" value="<%=request("id")%>">
...
<input type="hidden" name="name" value="<%=(rsPagedata.Fields.Item("headline").Value)%>">
<select name="sel_spl" class="dropdown">
<!--#include virtual="/log/insider/ei/menufiles/sel_ba.txt"-->
</select>
...
<td class="formLabeltext" align="center"> <br>
<br>
<input type="submit" name="Submit3" value="Fortryd"  class="formbutton"  onClick="this.form.action='/admin/bu/homepage/functions.asp';this.form.submit();">
<input type="submit" name="Submit" value="OK"  class="formbutton" onClick="if(form.sel_spl.selectedIndex>0){form.replacename.value=form.sel_spl.options[form.sel_spl.selectedIndex].text;return true};else{alert('Der skal vælges en erstatning.');return false}">
<br>
<br>
</td>
</tr>
