...
<tr> 
<td colspan="2" class="contentHeader1" align="left"> Sekretariatet</td>
</tr>
<tr> 
...
<tr> 
<td valign="top"> 
<p>Medarbejdere p&aring; sekretariatet:<br>
</p>
<% 
While ((Repeat1__numRows <> 0) AND (NOT rsPageData.EOF)) 
%>
<p><span class="listheader"><%=(rsPageData.Fields.Item("navn").Value)%></span><br>
<%=(rsPageData.Fields.Item("stilling").Value)%><br>
<a href="mailto:<%=rsPageData("email")%>"><%=rsPageData("email")%></a></p>
<% 
...
<tr> 
<td><span class="faktaboksheader">Kontakt &Oslash;ko-info</span><br>
<br>
Du kan ringe til &Oslash;ko-info p&aring; tlf. 62 24 43 24. <br>
