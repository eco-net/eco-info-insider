...
<input type="button" value="OK" class="formbutton" onClick="thetext=this.form.params.value.substring(1,this.form.params.value.length);thetext=thetext.replace('listoffset','offset');if(this.form.done.value==1){if(this.form.u.value.length)window.location='list.asp?'+thetext;else window.location='index.asp?'+thetext};else window.location='list.asp?'+thetext;">
<br>
<br>
</td>
</tr>
