...
<form name="form1" method="post" action="<%IF LEN(request.cookies("eiuserid"))=0 THEN response.write ("index.asp?" & MM_KeepURL) ELSE response.write ("list.asp?" & MM_KeepURL)%>">
...
<input type="button" name="" value="OK" class="formbutton" onClick="thetext=this.form.params.value.substring(1,this.form.params.value.length);thetext=thetext.replace('listoffset','offset');window.location=this.form.action+thetext">
<br>
<br>
</td>
</tr>
