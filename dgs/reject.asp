...
<div align="center"><span class="contentHeader1">Desv&aelig;rre</span> <span></span></div>
</td>
</tr>
<tr>
<td class="formLabeltext" align="center"><span class="formLabeltext"><br>
<br>
Organisationen <%=request("name")%><br>
eksisterer i &Oslash;ko-info databasen i forvejen</span></td>
</tr>
<tr> 
<td class="formLabeltext" align="center"> <br>
<br>
<input type="button" name="Button" value="Tilbage" class="formbuttonWide" onClick="history.go(-1);">
<input type="submit" value="Vis i &Oslash;ko-info" class="formbuttonWide" name="submit" onClick="window.location='http://www.eco-info.dk/dgs/detail.asp?id=<%=request("id")%>'">
<br>
<br>
</td>
</tr>
