...
<tr> 
<td> 
<p><span class="contentHeader1">Her kan din organisation &oslash;nske nye kategorier 
og emneord.</span></p>
<p><span class="listheader">Organisation: <%=request("name")%></span> 
<input type="hidden" name="orgname" value="<%=request("name")%>">
