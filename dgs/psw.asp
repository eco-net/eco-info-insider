...
<form method="post" action="act_psw.asp">
<tr> 
<td valign="top"> 
<table width="100%" border="0" cellspacing="0" cellpadding="0" background="/shared/graphics/spacer.gif">
<tr> 
<td class="contentHeader1">Ret brugernavn og adgangskode </td>
</tr>
<tr> 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
<tr valign="top"> 
<td> <p>Organisation / Firma / Projekt<br>
      Navn:<br>
  ...
  <br>
  Email:  <br>
  <input name="email" type="text" class="formInputobject" id="email" value="<%=request("email")%>">
  </p>
  <p><br>
    <strong>Brugernavn:    </strong><br>
      <input name="username" type="text" class="formInputobject" value="<%=request("username")%>">
      <br>
      <strong>Adgangskode:      </strong><br>
    <input name="password" type="text" class="formInputobject" value="<%=request("psw")%>">
...
<tr valign="top"> 
<td><p>&nbsp;</p>
  <p>Ved rettelse af brugernavn og adgangskode,<br>
    bliver brugeren tildelt en unik adgangskode,<br>
  og der sendes en mail med de nye oplysninger til brugeren. </p></td>
</tr>
</table>
<div align="left"><br>
