...
<!--include file="/shared/inc_access.asp" -->
...
<tr>
<td valign="top">
<p><b>1.</b>Inds&aelig;t (&AElig;ble-v eller ctrl-v) i de store felt. Hvis ikke der inds&aelig;ttes noget, m&aring; du pr&oslash;ve at klikke 'Opret p&aring; nettet'-knappen i Filemaker,  igen.<br>
<b>2.</b>Indtast brugernavn og adgangskode.<br>
<b>3.</b>Klik opret.<br>
<br>
<br>
N&aring;r kortet er oprettet, vises dets ID-nummer. Dette kopieres og inds&aelig;ttes i feltet &quot;Web-ID&quot; p&aring; kortet i Filemaker.<br>
<br>
Der sendes automatisk en velkomstmail til brugeren.</p>
</td>
</tr>
<tr>
<td><img src="/shared/graphics/spacer.gif" width="3" height="8"></td>
...
<form name="form1" method="post" action="act_newfromfmp.asp">
<span class="contentHeader1">Opret Organisation fra Filemaker</span><br>
<br>

<span class="formLabeltext">Inds&aelig;t i feltet nedenfor.</span><br>
<textarea name="sqlcode" rows="4" class="formTextobjectBigger"></textarea>
<br>
<span class="formLabeltext">Brugernavn:</span><br>
<input type="text" name="username" value="<%=request("username")%>" size="32" class="formInputobjectLong">
<span class="formLabeltext"><br>
Ønsket Adgangskode:</span><br>
<input type="text" name="password" value="<%=request("password")%>" size="32" class="formInputobjectLong">
<span class="formLabeltext"><br>
Email-adresse:</span><br>
<input type="text" name="email" value="<%= Request("mail") %>" size="32" class="formInputobjectLong">
<br>
<input type="button" name="Button" value="Opret" class="formbutton" onClick="newfromfmp(this.form);">
<script language="JavaScript">
document.forms[0].sqlcode.focus()
</script>
</form>
<%ELSE%>
<form>
<span class="contentHeader1">Kortet er oprettet.</span><br>
<br>
Kopier nedenst&aring;ende ID og inds&aelig;t det p&aring; kortet i Filemaker.<br>
<input type="text" value="<%=request("recid")%>" class="formInputobject">
<br>
<br>
<br>
Du b&oslash;r derefter validerer den nye organisation, og tilknytte den kategorier og emneord.
<br>
<div align="CENTER">
<input type="button" name="Button" value="Rediger kortet" class="formInputobject"onClick="window.location='edit.asp?id=<%=request("recid")%>';">
</div>
</form>
<%END IF%>
<!-- #EndEditable --> </td>
