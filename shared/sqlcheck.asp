...
BlackList = Array("/*","*/","@@","char","nchar","varchar","nvarchar","begin","cast","create","cursor","declare", "delete","drop","exec","execute","fetch","insert","kill","select","sysobjects","syscolumns","update","xp_")
