...
<tr> 
<td width="30%" bgcolor="#CCCCCC"><span class="listheader">&nbsp;Linktekst:</span> 
<input type="text" name="linktext4" value="<%=(rsPageData.Fields.Item("linktext4").Value)%>" class="formInputobject">
</td>
<td width="30%" valign="top" bgcolor="#CCCCCC"><span class="listheader">Link:</span> 
<input value="<%=(rsPageData.Fields.Item("FileName4").Value)%>" type="text" name="link4" size="32" class="formInputobject">
</td>
</tr>
...
<td width="30%">Skriv Billednr: 
<input type="text" name="img_id2" size="4" value="<%=(rsPageData.Fields.Item("img_id2").Value)%>">
</td>
<td width="60%">&nbsp;</td>
</tr>
</table>
