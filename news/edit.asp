...
<tr> 
<td class="contentHeader1"> Rediger Nyhed id: <%=(rsPageData.Fields.Item("Artikel_ID").Value)%></td>
</tr>
<tr> 
...
<!--#include virtual="/shared/editor.asp"--></td>
</tr>
<tr valign="top">
  <td colspan="2">&nbsp;</td>
</tr>
<tr valign="top">
  <td><table width="100%" border="0" cellpadding="0">
    <tr>
      ...
      <td><input value="<%=(rsPageData.Fields.Item("FileName").Value)%>" type="text" name="link" size="32" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Linktekst:</span></td>
      <td><input type="text" name="linktext" value="<%=(rsPageData.Fields.Item("linktext").Value)%>" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Link2:</span></td>
      <td><input value="<%=(rsPageData.Fields.Item("FileName2").Value)%>" type="text" name="link2" size="32" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Linktekst:</span></td>
      <td><input type="text" name="linktext2" value="<%=(rsPageData.Fields.Item("linktext2").Value)%>" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Link3:</span></td>
      <td><input value="<%=(rsPageData.Fields.Item("FileName3").Value)%>" type="text" name="link3" size="32" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Linktekst:</span></td>
      <td><input type="text" name="linktext3" value="<%=(rsPageData.Fields.Item("linktext3").Value)%>" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Link4:</span></td>
      <td><input value="<%=(rsPageData.Fields.Item("link4").Value)%>" type="text" name="link4" size="32" class="formInputobject"></td>
    </tr>
    <tr>
      <td><span class="listheader">Linktekst:</span></td>
      <td><input type="text" name="linktext4" value="<%=(rsPageData.Fields.Item("linktext4").Value)%>" class="formInputobject"></td>
    </tr>
    <tr>
...
<tr valign="top">
  ...
  <td><table width="100%" border="0" cellpadding="0">
    <tr>
      <td><span class="listheader">Inds&aelig;t billede i h&oslash;jre kolonne (Rightbar)</span></td>
    </tr>
    <tr>
      <td><a href="/shared/picasa.asp" target="_blank"><strong>Billede1 fra Picasa</strong></a><a href="/shared/picasa.asp"></a>:<br>
        <input name="imagefilename12" type="text" class="formInputobjectLong" id="imagefilename12" value="<%=rsPageData("imagefilename1")%>" size="40" /></td>
    </tr>
    <tr>
      <td>Billedtekst:<br>
        <input name="img_text3" type="text" class="formInputobject" value="<%=rsPageData("img_text")%>"></td>
    </tr>
  </table></td>
</tr>
</table>
...
<tr> 
<td><div align="right"></div><div align="right"></div><div align="center"></div> 
<div align="left">
  <p class="formLabeltext">
    <label></label>
    </p>
    <p align="center" class="formLabeltext"><br>
