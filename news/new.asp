...
<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" background="/shared/graphics/spacer.gif">
  ...
  <tr>
    <td valign="top"><%'IF LEN(request.cookies("eiuserid"))>0 THEN
...
%>
            ...
            <tr valign="top">
              <td colspan="2"><span class="formLabeltext">*Uddybende beskrivelse:</span>
                  <textarea name="EditorValue" style="display: none;">
            ...
            <tr valign="top">
              <td><table width="100%" border="0" cellpadding="0">
                  <tr>
                    ...
                    <td><input type="text" name="link" size="32" class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Linktekst 
                      1:</span></td>
                    <td><input type="text" name="linktext" value="l&aelig;s mere..." class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Link 2:</span></td>
                    <td><input type="text" name="link2" size="32" class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Linktekst 2:</span></td>
                    <td><input type="text" name="linktext2" value="l&aelig;s mere..." class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Link 3:</span></td>
                    <td><input type="text" name="link3" size="32" class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Linktekst 3:</span></td>
                    <td><input type="text" name="linktext3" value="l&aelig;s mere..." class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Link 4:</span></td>
                    <td><input type="text" name="link4" size="32" class="formInputobject"></td>
                  </tr>
                  <tr>
                    <td><span class="listheader">Linktekst 4:</span></td>
                    <td><input type="text" name="linktext4" value="l&aelig;s mere..." class="formInputobject"></td>
                  </tr>
                  <tr>
            ...
            <tr valign="top">
              <td><table width="100%" border="0" cellpadding="0">
                  ...
                  <tr>
                    <td>Billedtekst:<br>
                        <input type="text" name="img_text2" class="formInputobject"></td>
                  </tr>
              </table></td>
              <td><table width="100%" border="0" cellpadding="0">
                  <tr>
                  ...
                  <tr>
                    <td>Billedtekst:<br>
                        <input type="text" name="img_text" class="formInputobject"></td>
                  </tr>
              </table></td>
            </tr>
          </table>
...
TEMA-->
            ...
            <tr>
              <td><p align="center" class="formLabeltext">
