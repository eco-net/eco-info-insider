...
rsPageData.Source = "SELECT Artikel_ID, CreateDate, Header, Approved, maker,create_date  FROM bu_Artikel a  WHERE 0=0  ORDER BY a.Artikel_ID DESC"
...
<tr> 
<td valign="top"> 
<p>Klik p&aring; <span class="listheader">nyhedstitlen</span> for at g&aring; 
til redigering og godkendelse</p>
</td>
</tr>
<tr> 
<td><img src="/shared/graphics/spacer.gif" width="3" height="8"></td>
...
<td class="contentHeader1" colspan="2" width="98%"><%=header%></td>
...
<tr> 
<td colspan="5" background="/shared/graphics/layout/dots_horz.gif" height="1"><img src="/shared/graphics/spacer.gif" width="3" height="1"></td>
</tr>
...
%>
<tr> 
<td><a href="edit.asp?id=<%=(rsPageData.Fields.Item("Artikel_ID").Value)%>"><%=toString(rsPageData.Fields.Item("Header").Value)%></a> </td>
<td></td>
<td> 
<div align="right"><font color="#FF0000">oprettet: 
<%=(rsPageData.Fields.Item("create_date").Value)%>
af <%=(rsPageData.Fields.Item("maker").Value)%></font></div>
</td>
</tr>
<% 
...
<td class="contentHeader1" height="22">&nbsp; </td>
<td width="8"><br>
</td>
</tr>
<tr> 
