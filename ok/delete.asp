...
rsOrg.Source = "SELECT o.id  FROM eiorg_maindata o LEFT JOIN eical_r_org l ON o.id=l.orgid  WHERE l.calid=" + Replace(rsOrg__ColParam, "'", "''") + ""
rsOrg.CursorType = 0
...
<%
DIM theText
theText="Du er ved at slette et arrangement.<br><br>Er du sikker på at du vil fortsætte ? "
%>
