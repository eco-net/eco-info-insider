...
rsExecute.ActiveConnection = "Driver={Microsoft Access Driver (*.mdb)};DBQ=" + Server.MapPath("/dbadmin/data.mdb")
...
rsTemplates.ActiveConnection = "Driver={Microsoft Access Driver (*.mdb)};DBQ=" + Server.MapPath("/dbadmin/data.mdb")
...
rsTemplate.ActiveConnection = "Driver={Microsoft Access Driver (*.mdb)};DBQ=" + Server.MapPath("/dbadmin/data.mdb")
