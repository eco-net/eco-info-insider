...
rsPageData.Source = "SELECT m.id,m.title,m.subtitle,m.shortdescr,m.author,m.webaddress,m.maker,m.edit,m.createdate,m.modidate  FROM eiart_maindata m  WHERE 0=0  ORDER BY m.title"
...
<td class="contentHeader1" colspan="2" width="98%">Fandt <%=rsPageData_total%> artikler <font color="#FF0000"><%=validtext%></font></td>
...
<td class="contentHeader1" height="22">Fandt ingen artikler</td>
<td width="8"><br>
</td>
</tr>
<tr> 
...
<br>
<br>
Der er ingen artikler i Artikelbasen, der matcher din søgning.<br>
