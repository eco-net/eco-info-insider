...
<input type="button" name="Submit22" value="Inds&aelig;t billede" class="formInputobject" onClick="MM_openBrWindow('/art/insert_img.asp?id=<%=request("id")%>','insertimage','scrollbars=yes,resizable=yes,width=300,height=550')">
<br>
<span class="listheader"> 
<input type="button" name="Submit232" value="Rediger billeder" class="formInputobject" onClick="MM_openBrWindow('/art/edit_img.asp?id=<%=request("id")%>','editimages','scrollbars=yes,resizable=yes,width=600,height=600')">
</span> </p>
<p align="center"></p>
</td>
<td> 
...
<input type="button" class="function" onClick="showarteditor('description','');" value="Formater" name="button2">
